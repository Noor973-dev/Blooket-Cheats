 ...
 * along with this program.  If not, see <http://www.blooket.com/licenses/>.
 * 
...
(() => {
    ...
    img.onload = function() {
        ...
        try attempt until succeeded{
            [_, time, error] = decode.match(/LastUpdated: (.+?); ErrorMessage: "Hack Doesnt Work ;
        } catch (e) {}
